...
Gallery.soy.start = function(opt_data, opt_ignored, opt_ijData) {
  return BlocklyGames.soy.headerBar({appName: soy.$$escapeHtml(opt_ijData.appName) + '\u5C55\u5ECA', levelLinkSuffix: '', hasLinkButton: false, hasHelpButton: false, farLeftHtml: ''}, null, opt_ijData) + '<div id="gallery"></div><div id="loading"><img src="common/loading.gif"></div>';
};
if (goog.DEBUG) {
