...
Pond.Duck.soy.start = function(opt_data, opt_ignored, opt_ijData) {
  return '' + Pond.Duck.soy.messages(null, null, opt_ijData) + BlocklyGames.soy.headerBar({appName: 'D\u012B\u0137is', levelLinkSuffix: '', hasLinkButton: false, hasHelpButton: false, farLeftHtml: ''}, null, opt_ijData) + Pond.soy.visualization(null, null, opt_ijData) + '<div id="tabarea"><div id="editorBar" class="tab-bar"><div class="tab tab-selected">Bloki</div><div class="tab">JavaScript</div></div><div class="tab-bar-clear"></div><div id="blockly"></div><div id="editor"></div></div>' + Pond.Duck.soy.toolbox(null, null, opt_ijData) + Pond.Duck.soy.playerRabbit(null, null, opt_ijData) + Pond.Duck.soy.playerCounter(null, null, opt_ijData) + Pond.Duck.soy.playerRook(null, null, opt_ijData) + Pond.Duck.soy.playerSniper(null, null, opt_ijData) + BlocklyGames.soy.dialog(null, null, opt_ijData);
};
if (goog.DEBUG) {
