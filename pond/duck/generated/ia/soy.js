...
Pond.Duck.soy.messages = function(opt_data, opt_ignored, opt_ijData) {
  return Pond.soy.messages(null, null, opt_ijData) + '<div style="display: none"><span id="Pond_rabbitName">Conilio</span><span id="Pond_counterName">Contator</span><span id="Pond_rookName">Turre</span><span id="Pond_sniperName">Tirator imboscate</span><span id="Pond_myName">Jocator</span></div>';
};
if (goog.DEBUG) {
