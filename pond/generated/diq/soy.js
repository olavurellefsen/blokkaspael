...
Pond.soy.visualization = function(opt_data, opt_ignored, opt_ijData) {
  return '<div id="visualization"><canvas id="scratch" width="400" height="400" style="display: none"></canvas><canvas id="display" width="400" height="400"></canvas></div><table id="avatarStatTable"><tbody><tr id="avatarStatRow1"></tr><tr id="avatarStatRow2"></tr></tbody></table><table width="400"><tr><td style="width: 190px; text-align: center; vertical-align: top;"><button id="docsButton" title="Display the language documentation.">Dokumentasyon</button></td><td><button id="runButton" class="primary" title="Pro\u011Framo ke to nusnayo b\u0131xebetne."><img src="common/1x1.gif" class="run icon21"> Programi Akar fi</button><button id="resetButton" class="primary" style="display: none" title="Pro\u011Frami v\u0131ndarn\u0131 u sewiyay reset ke."><img src="common/1x1.gif" class="stop icon21"> Ra\u00E7arne</button></td></tr></table><div id="dialogDocs"><img src="common/1x1.gif" class="close icon21" id="closeDocs"><iframe id="frameDocs"></iframe></div>';
};
if (goog.DEBUG) {
