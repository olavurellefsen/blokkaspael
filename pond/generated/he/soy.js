...
Pond.soy.visualization = function(opt_data, opt_ignored, opt_ijData) {
  return '<div id="visualization"><canvas id="scratch" width="400" height="400" style="display: none"></canvas><canvas id="display" width="400" height="400"></canvas></div><table id="avatarStatTable"><tbody><tr id="avatarStatRow1"></tr><tr id="avatarStatRow2"></tr></tbody></table><table width="400"><tr><td style="width: 190px; text-align: center; vertical-align: top;"><button id="docsButton" title="\u05D4\u05E6\u05D2\u05EA \u05D4\u05EA\u05D9\u05E2\u05D5\u05D3 \u05E2\u05D1\u05D5\u05E8 \u05D4\u05E9\u05E4\u05D4.">\u05EA\u05D9\u05E2\u05D5\u05D3</button></td><td><button id="runButton" class="primary" title="\u05D4\u05E8\u05E5 \u05D0\u05EA \u05D4\u05EA\u05D5\u05DB\u05E0\u05D9\u05EA \u05E9\u05DB\u05EA\u05D1\u05EA."><img src="common/1x1.gif" class="run icon21"> \u05D4\u05E8\u05E5 \u05EA\u05DB\u05E0\u05D9\u05EA</button><button id="resetButton" class="primary" style="display: none" title="Stop the program and reset the level."><img src="common/1x1.gif" class="stop icon21"> \u05D0\u05D9\u05E4\u05D5\u05E1</button></td></tr></table><div id="dialogDocs"><img src="common/1x1.gif" class="close icon21" id="closeDocs"><iframe id="frameDocs"></iframe></div>';
};
if (goog.DEBUG) {
