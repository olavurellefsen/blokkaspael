...
Pond.soy.visualization = function(opt_data, opt_ignored, opt_ijData) {
  return '<div id="visualization"><canvas id="scratch" width="400" height="400" style="display: none"></canvas><canvas id="display" width="400" height="400"></canvas></div><table id="avatarStatTable"><tbody><tr id="avatarStatRow1"></tr><tr id="avatarStatRow2"></tr></tbody></table><table width="400"><tr><td style="width: 190px; text-align: center; vertical-align: top;"><button id="docsButton" title="Display the language documentation.">\u0410\u0434\u043E\u043A\u0443\u043C\u0435\u043D\u0442\u0430\u0446\u0438\u044F</button></td><td><button id="runButton" class="primary" title="\u0418\u0434\u04D9\u044B\u049B\u04D9\u04B5\u0430 \u0435\u0438\u049B\u04D9\u0443\u0440\u0448\u04D9\u0430\u0437 \u0430\u043F\u0440\u043E\u0433\u0440\u0430\u043C\u043C\u0430."><img src="common/1x1.gif" class="run icon21"> \u0418\u0434\u04D9\u044B\u049B\u04D9\u04B5\u0430\u0442\u04D9\u0443\u043F \u0430\u043F\u0440\u043E\u0433\u0440\u0430\u043C\u043C\u0430</button><button id="resetButton" class="primary" style="display: none" title="Stop the program and reset the level."><img src="common/1x1.gif" class="stop icon21"> \u0418\u049B\u04D9\u0433\u0430\u0442\u04D9\u0443\u043F</button></td></tr></table><div id="dialogDocs"><img src="common/1x1.gif" class="close icon21" id="closeDocs"><iframe id="frameDocs"></iframe></div>';
};
if (goog.DEBUG) {
