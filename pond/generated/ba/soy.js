...
Pond.soy.visualization = function(opt_data, opt_ignored, opt_ijData) {
  return '<div id="visualization"><canvas id="scratch" width="400" height="400" style="display: none"></canvas><canvas id="display" width="400" height="400"></canvas></div><table id="avatarStatTable"><tbody><tr id="avatarStatRow1"></tr><tr id="avatarStatRow2"></tr></tbody></table><table width="400"><tr><td style="width: 190px; text-align: center; vertical-align: top;"><button id="docsButton" title="Display the language documentation.">Documentation</button></td><td><button id="runButton" class="primary" title="\u042F\u0499\u0493\u0430\u043D \u043F\u0440\u043E\u0433\u0440\u0430\u043C\u043C\u0430\u04A3\u0434\u044B \u0442\u043E\u04A1\u0430\u043D\u0434\u044B\u0440."><img src="common/1x1.gif" class="run icon21"> \u041F\u0440\u043E\u0433\u0440\u0430\u043C\u043C\u0430\u043D\u044B \u0435\u0431\u04D9\u0440\u0435\u04AF</button><button id="resetButton" class="primary" style="display: none" title="\u041F\u0440\u043E\u0433\u0440\u0430\u043C\u043C\u0430\u043D\u044B \u04E9\u0499\u04D9 \u04BB\u04D9\u043C \u0431\u0430\u0448\u043B\u0430\u043D\u0493\u044B\u0441 \u0442\u043E\u0440\u043E\u0448\u043E\u043D\u0430 \u044B\u0440\u0493\u044B\u0442\u0430."><img src="common/1x1.gif" class="stop icon21"> \u0422\u0430\u0499\u0430\u0440\u0442\u044B\u0440\u0493\u0430</button></td></tr></table><div id="dialogDocs"><img src="common/1x1.gif" class="close icon21" id="closeDocs"><iframe id="frameDocs"></iframe></div>';
};
if (goog.DEBUG) {
