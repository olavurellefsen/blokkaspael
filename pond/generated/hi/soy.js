...
Pond.soy.visualization = function(opt_data, opt_ignored, opt_ijData) {
  return '<div id="visualization"><canvas id="scratch" width="400" height="400" style="display: none"></canvas><canvas id="display" width="400" height="400"></canvas></div><table id="avatarStatTable"><tbody><tr id="avatarStatRow1"></tr><tr id="avatarStatRow2"></tr></tbody></table><table width="400"><tr><td style="width: 190px; text-align: center; vertical-align: top;"><button id="docsButton" title="Display the language documentation.">Documentation</button></td><td><button id="runButton" class="primary" title="\u0906\u092A\u0928\u0947 \u091C\u094B \u0932\u093F\u0916\u093E \u0939\u0948, \u0909\u0938\u0947 \u0930\u0928 \u0915\u0930\u0947\u0902\u0964"><img src="common/1x1.gif" class="run icon21"> \u092A\u094D\u0930\u094B\u0917\u094D\u0930\u093E\u092E \u091A\u0932\u093E\u090F\u0901</button><button id="resetButton" class="primary" style="display: none" title="\u0915\u093E\u0930\u094D\u092F\u0915\u094D\u0930\u092E \u0915\u094B \u092C\u0902\u0926 \u0915\u0930\u0947\u0902 \u0914\u0930 \u0938\u094D\u0924\u0930 \u0930\u0940\u0938\u0947\u091F \u0915\u0930\u0947\u0902\u0964."><img src="common/1x1.gif" class="stop icon21"> \u0930\u0940\u0938\u0947\u091F \u0915\u0930\u0947\u0902</button></td></tr></table><div id="dialogDocs"><img src="common/1x1.gif" class="close icon21" id="closeDocs"><iframe id="frameDocs"></iframe></div>';
};
if (goog.DEBUG) {
